...
const Points = () => {
  ...
  const handleWhatsapp = () =>{
    Linking.openURL(`whatsapp://send?phone=${pointDetail.point.whatsapp}&text=Tenho interesse sobre coleta de residuo`);
  }
  ...
  return (
    <SafeAreaView style={{flex: 1}}>
      <View  style={styles.container}>
        ...
        <Image style={styles.pointImage} source={{uri: pointDetail.point.image}}/>
      
        <Text style={styles.pointName}>{ pointDetail.point.name}</Text>
        <Text style={styles.pointItems}>
          { pointDetail.items.map(item => { return item.title}).join(', ')}
        </Text>
